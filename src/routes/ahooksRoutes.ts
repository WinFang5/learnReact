...
export default [
  ...
  {
    path: '/ahooks/useEventTarget',
    component: './AhooksApi/Dom/UseEventTargetTest',
  },
  {
    path: '/ahooks/useExternal',
    component: './AhooksApi/Dom/UseExternalTest',
  },
  {
    path: '/ahooks/useTitle',
    component: './AhooksApi/Dom/UseTitleTest',
  },
  {
    path: '/ahooks/useFavicon',
    component: './AhooksApi/Dom/UseFaviconTest',
  },
  {
    path: '/ahooks/useFullscreen',
    component: './AhooksApi/Dom/UseFullscreenTest',
  },
  {
    path: '/ahooks/useHover',
    component: './AhooksApi/Dom/UseHoverTest',
  },
  {
    path: '/ahooks/useMutationObserver',
    component: './AhooksApi/Dom/UseMutationObserverTest',
  },
  {
    path: '/ahooks/useInViewport',
    component: './AhooksApi/Dom/UseInViewportTest',
  },
  {
    path: '/ahooks/useKeyPress',
    component: './AhooksApi/Dom/UseKeyPressTest',
  },
  {
    path: '/ahooks/useLongPress',
    component: './AhooksApi/Dom/UseLongPressTest',
  },
  {
    path: '/ahooks/useMouse',
    component: './AhooksApi/Dom/UseMouseTest',
  },
  {
